...
int main(void)
{
	...
	xTaskCreate(	vtemperatur, "vtemperatur", configMINIMAL_STACK_SIZE, NULL, 1, &xHandleStatus);

	xTaskCreate(	vpotentiometer, "vpotentiometer", configMINIMAL_STACK_SIZE, NULL, 1, &xHandleStatus);

	xTaskCreate(	vlight, "vlight", configMINIMAL_STACK_SIZE, NULL, 1, &xHandleStatus);
